                ...
                <div className="doc">
                    ...
                    <div className="right-panel">
                        ...
                        <div className="right-panel__languages">
                            <h3 className="right-panel__languages__title">
                                Idiomas
                            </h3>
                            <ul className="list pl0 mv0">
                                {languages.map((item) => {
                        ...
                        <div className="right-panel__education">
                            <h3 className="right-panel__education__title">
                                Educación
                            </h3>
                            <ul className="list pl0 mv0">
                                {education.map((item) => {
                                    return (
                                        ...
                                        >
                                            ...
                                            <span className="right-panel__education__item__title db">
                                                {item.title}
                                            </span>
                        ...
                        <div className="right-panel__achievements">
                            <h3 className="right-panel__achievements__title">
                                Logros
                            </h3>
                            <ul className="list pl0 mv0">
